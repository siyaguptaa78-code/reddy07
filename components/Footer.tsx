...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#05080f] border-t border-[#9C27B0]/10 pt-16 pb-8 px-4 md:px-8 select-none">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 text-left">
        ...
        <div className="flex flex-col gap-4">
          <h4 className="text-white font-black text-lg border-b border-[#9C27B0]/10 pb-2 mb-2">
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-[#9C27B0]/5 flex flex-wrap justify-center items-center gap-6 md:gap-10">
      ...
      {/* Copyright Bottom */}
      <div className="max-w-7xl mx-auto mt-10 pt-6 border-t border-[#9C27B0]/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500 font-semibold">
