      ...
      <div className="w-full flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-3/4 flex flex-col gap-8 text-left">
          ...
          <section className="w-full bg-[#0c1322] border border-[#9C27B0]/10 rounded-md p-6 md:p-8 flex flex-col gap-4 shadow-lg shadow-black">
            ...
            <p className="text-gray-400 text-xs md:text-sm font-bold bg-[#05080f] px-3 py-1.5 rounded-lg border border-[#9C27B0]/5 self-start">
              Last Updated: May 14, 2026
            </p>
            <div className="text-gray-300 text-sm md:text-base leading-relaxed flex flex-col gap-4">
              <p>
                At Reddy Anna Book, accessible from reddypurplebook.in, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Reddy Anna Book and how we use it.
              </p>
