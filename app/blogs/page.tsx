          ...
          <section className="w-full flex flex-col gap-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={idx}
                  className="bg-[#0c1322] border border-[#9C27B0]/10 hover:border-[#9C27B0]/25 rounded-sm p-5 md:p-6 shadow-md hover:scale-[1.002] transition-all flex flex-col gap-3 group"
                >
                  <div className="text-xs text-gray-400 font-bold bg-[#05080f] self-start px-2.5 py-1 rounded-md border border-[#9C27B0]/5">
                    📅 {blog.date}
                  </div>
