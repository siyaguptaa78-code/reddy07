    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-8 select-none">
      <div className="w-full flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-3/4 flex flex-col gap-8 text-left">
          ...
          <section className="w-full bg-[#0c1322] border border-[#9C27B0]/10 rounded-md p-6 md:p-8 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="bg-[#05080f] p-5 rounded-sm border border-[#9C27B0]/5 shadow-md">
          ...
          <section className="w-full bg-[#0c1322] border border-[#9C27B0]/10 rounded-md p-6 md:p-8 flex flex-col gap-4">
            <h3 className="text-[#FF4081] font-black text-xl md:text-2xl tracking-wide mb-2">
          ...
          <section className="w-full bg-[#0c1322] border border-[#9C27B0]/10 rounded-md p-6 md:p-8 text-center flex flex-col items-center gap-4">
