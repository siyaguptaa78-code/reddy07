    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-8 select-none">
      <div className="w-full flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-3/4 flex flex-col gap-8 text-left">
          ...
          {/* Call to Action */}
          <section className="w-full bg-[#0c1322] border border-[#9C27B0]/10 rounded-md p-6 md:p-8 text-center md:text-left flex flex-col items-center md:items-start gap-4">
            <h3 className="text-[#FF4081] font-black text-xl md:text-2xl">
